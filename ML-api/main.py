...
app = FastAPI()
os.environ['GROQ_API_KEY'] = "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"
...
# set up LLM
llm = ChatGroq(model_name="llama3-70b-8192", api_key="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")
