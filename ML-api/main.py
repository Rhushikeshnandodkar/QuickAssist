...
app = FastAPI()
os.environ['GROQ_API_KEY'] = "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"
...
# set up LLM
llm = ChatGroq(model_name="llama3-70b-8192", api_key="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")
